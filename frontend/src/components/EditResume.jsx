...
const EditResume = () => {
    ...
    // TAKE BACK TO PREVIOUS FORM STATE OR IT WILL TAKE BACK TO FRONT OR  DASHBOARD
    const goBack = () => {
        const pages = [
            "profile-info",
            "contact-info",
    ...
    // REMOVE NEW ITEM IN INFORMATION
    ...
    // FETCH RESUME DETAIL BY ID OR BACKEND URL
    ...
    // IT WILL HELP IN CHOOSING PREVIEW AS WELL AS DOWNLOAD 
    ...
    // UPDATE RESUME DETAILS AS THUMBNAIL LINK
    ...
    // SO ALL THIS FUNCTION USE FOR EDIT RESUME
