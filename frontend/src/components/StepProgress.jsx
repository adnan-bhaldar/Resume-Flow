  ...
  return (
    <>
      ...
      border border-white/10">
        ...
        {/* MAIN PROGRESS BAR */}
        <div className="relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-fuchsia-600
        animate-flow bg-[length:200%_100%] translate-full duration-700 ease-out rounded-full overflow-hidden
        animate-pulse-glow" style={{ width: `${progress}%` }}>
          ...
          <div className="absolute inset-0 opacity-80">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="absolute top-1/2 w-2 h-2 bg-white rounded-full animate-bubble"
                style={{
                  left: `${(i + 1) * 12}%`,
